        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a href="user-profile.php"><strong class="btn btn-primary"><?php echo $_SESSION['username']; ?></strong></a>
                <a name="logout" id="" class="btn btn-primary" href="logout.php" role="button">Logout</a>
                      ...
                      <?php
                            ...
                            while ($post=mysqli_fetch_assoc($sqlquery)) {
                              ...
                              ?>
                                ...
                                <a href="../Showing_Blog/full_post.php?post_id=<?=$post["Id"]?>" style="text-decoration:none; color:black;">
                                  <div class="row g-0">
