...
if (isset($_POST['save'])) {
    ...
    $updatequery = "UPDATE `blogpost` SET Id=$id, Title='$title', Description='$content' WHERE id=$id ";
      ...
      <div class="col-lg-3">
        <main>
          <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
            ...
            <a href="../main.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
      ...
      <div class="col-lg-7 profile_table_section_color">
                <div class="profile_table_section mt-3">
                    <div class=" text-center ">
                        <h3 class="bg-dark p-3"> <span style="color:#fff">Update Your Post</span> </h3>
                ...
                <form action="" method="POST">
                    <input type="text" placeholder="Blog Title" class="form-control my-3 bg-dark text-white text-center" name="title" value="<?php echo $title ?>">
                    <textarea name="content" placeholder="Description"  class="form-control my-3 bg-dark text-white" cols="30" rows="10" value="<?php echo $description ?>"></textarea>
                    <button class="btn btn-dark" name="save">Save Post</button>
                </form>
           </div>
                      <!--  -->
