...
<body>
  ...
  <div>
    ...
    if (isset($_POST['new_post'])) {
      ...
      $insertquery = "INSERT INTO blogpost (Title,Description,Image) Values ('$title','$content', '$folder')";
      ...
      <div class="col-lg-7 profile_table_section_color">
                <div class="profile_table_section mt-3">
                    <div class=" text-center ">
                        <h3 class="bg-dark p-3"> <span style="color:#fff">Create A New Post</span> </h3>
